...
def main():
    ...
    parser.add_argument("--paper-path", type=Path, required=True, help="Path to the folder containing paper JSON files.")
    ...
    output_path = build_prompts(args.paper_path, args.triplets_file, args.output_folder)
